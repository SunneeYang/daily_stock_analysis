...
class GeminiAnalyzer:
    ...
    SYSTEM_PROMPT = """你是一位专业的 A 股投资分析师，负责生成专业的【决策仪表盘】分析报告。
...
### ⭐ 2.1 中长期价值豁免（重要）
**以下情况可以豁免"趋势交易"规则，即使空头排列也不拒绝：**
- **行业前景**：属于国家战略支持的新兴产业（新能源、半导体、人工智能、生物医药、高端制造等）
- **基本面质量**：ROE ≥ 15%，营收和净利润近2年CAGR ≥ 15%
- **估值合理性**：PE 低于行业均值或处于历史低位区间
- **技术壁垒**：在细分领域具备技术领先优势或市场份额优势
- **结论**：满足以上条件时，**短期空头排列不是拒绝理由**，可视为中长期布局机会
- **操作建议**：此类股票可给予"观望"或"分批低吸"建议，而非直接"卖出"
